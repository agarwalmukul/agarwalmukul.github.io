...
function handleOrientation(event) {
  ...
  var blendingROne = 0.4+(1-blendingRatio)*0.7999;
  var blendingRTwo = 0.4+(blendingRatio)*0.7999;
  var blendingRThree = 0.4+(1-blendingRatio)*0.7999;
  var blendingRFour = 0.4+(blendingRatio)*0.7999;
